...
| [Verification: Image Captcha](https://github.com/simousa/nocobase-plugin) | Require users to enter a verification code (character-based or arithmetic-based) when logging in, registering, recovering a password, or submitting public forms. | 在用户登录、注册、找回密码以及公开表单提交时要求输入验证码（字符验证码/算数验证码）。 |
## Contributing
